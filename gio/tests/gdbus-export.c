...
{
  test_dispatch_thread_func_args* args = user_data;
...
static void
test_dispatch (const gchar *object_path, gboolean check_remote_errors)
{
  GThread *thread;
  
  test_dispatch_thread_func_args args = {object_path, check_remote_errors};
